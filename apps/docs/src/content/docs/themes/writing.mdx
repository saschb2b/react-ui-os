...
The fastest start is the [theme editor](/theme-editor/): pick a base theme, click the tokens into shape on a live desktop, and copy the generated file into your project. This page covers what that file means and the patterns for authoring one by hand.
