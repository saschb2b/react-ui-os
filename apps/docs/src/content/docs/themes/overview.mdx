...
<img
  src={windowsShot.src}
  alt="The Windows theme: a dark Windows-style desktop with a caption-button window and a bottom taskbar showing a Start launcher, centered app icons, and a clock, over a dark Windows 11 wallpaper"
  style={{
    maxWidth: "100%",
    height: "auto",
    borderRadius: "8px",
