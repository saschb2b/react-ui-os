...
<LivePreview src="?demo=dock" label="Hover a dock tile or a workspace pip to see the themed tooltip" height="460px" />
...
| ----------- | ------------------------------------- | ------- | -------------------------------------------------------- |
| `text`      | `string`                              | —       | Body line. Keep glanceable.                              |
| `shortcut`  | `string`                              | —       | Optional right-aligned hint (`"⌘K"`, `"F2"`, `"↵"`).     |
